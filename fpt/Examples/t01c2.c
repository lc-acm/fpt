...
int main(int argc, char **argv)
{
   ...
   if (argc != 3) {
     printf("usage : pgm swidth sheight\n") ;
     exit(0) ;
   }
   ...
   G_get_current_window_dimensions(dim) ;
   G_line (0, 0, dim[0]-1, dim[1]-1) ;
   ...
   G_rgb (0.5, 0.0, 1.0) ;// what color is this?
   ...
   G_save_image_to_file ("t01c2.xwd") ;
